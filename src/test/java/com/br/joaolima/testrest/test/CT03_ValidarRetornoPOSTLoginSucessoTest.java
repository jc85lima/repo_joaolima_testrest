...
public class CT03_ValidarRetornoPOSTLoginSucessoTest extends BaseTestHTTP {

	private static final String PATH_DATA = "CT03_ValidarRetornoPOSTLoginSucessoTest.json";
